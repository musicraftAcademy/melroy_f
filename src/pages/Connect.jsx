        ...
        <div className="my-5 flex flex-col items-center">
          <div className="w-2/4">
            ...
            <ul className="list-none mb-6">
              ...
              <li className="mb-3">
                <span className="font-bold">Address:</span> 123 Music Lane,
                Harmony Heights, Mangalore, India
              </li>
            </ul>

            <h3 className="text-2xl font-semibold mb-4">Social Media</h3>
            <p className="mb-6">
              Follow Melroy on social media to stay updated on his latest
              projects, performances, and music adventures.
            </p>
            ...
            <h3 className="text-2xl font-semibold mb-4">Work with Me</h3>
            <p className="mb-6">
